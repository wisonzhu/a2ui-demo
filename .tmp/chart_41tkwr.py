...
chart = json.loads('''{"chartType":"bar","title":{"literalString":"苹果销量（单位：万部）"},"labels":["Q1","Q2","Q3","Q4"],"datasets":[{"label":"销量","data":[100,150,200,300]}],"sizes":{"width":600,"height":400}}''')
...
labels = ["Q1","Q2","Q3","Q4"]
datasets = [{"label":"销量","data":[100,150,200,300]}]
chartType = "bar"
...
plt.tight_layout()
plt.savefig("/Users/wisonzhu/projects/ag-ui-demo/.tmp/chart_41tkwr.png", dpi=100, bbox_inches='tight', facecolor='#0d1117')
