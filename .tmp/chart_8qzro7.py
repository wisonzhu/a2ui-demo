...
chart = json.loads('''{"chartType":"bar","title":{"literalString":"季度销量"},"labels":["Q1","Q2","Q3","Q4"],"datasets":[{"label":"销量","data":[120,200,180,250]}],"sizes":{"width":600,"height":400}}''')
...
plt.tight_layout()
plt.savefig("/Users/wisonzhu/projects/ag-ui-demo/.tmp/chart_8qzro7.png", dpi=100, bbox_inches='tight', facecolor='#0d1117')
