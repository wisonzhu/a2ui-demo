...
chart = json.loads('''{"chartType":"bar","title":{"literalString":"2024各季度产品销量"},"labels":["Q1","Q2","Q3","Q4"],"datasets":[{"label":"销量","data":[120,200,180,250]}],"sizes":{"width":600,"height":400}}''')
...
labels = ["Q1","Q2","Q3","Q4"]
datasets = [{"label":"销量","data":[120,200,180,250]}]
chartType = "bar"
...
plt.tight_layout()
plt.savefig("/Users/wisonzhu/projects/ag-ui-demo/.tmp/chart_njfliy.png", dpi=100, bbox_inches='tight', facecolor='#0d1117')
