...
chart = json.loads('''{"chartType":"bar","title":{"literalString":"柱状图示例"},"labels":["一月","二月","三月","四月","五月","六月"],"datasets":[{"label":"数据集1","data":[12,19,3,5,2,3]}],"sizes":{"width":400,"height":300}}''')
...
datasets = [{"label":"数据集1","data":[12,19,3,5,2,3]}]
chartType = "bar"
...
plt.tight_layout()
plt.savefig("/Users/wisonzhu/projects/ag-ui-demo/.tmp/chart_zs3x8t.png", dpi=100, bbox_inches='tight', facecolor='#0d1117')
