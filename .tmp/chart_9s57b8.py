...
chart = json.loads('''{"chartType":"bar","title":{"literalString":"销量 (单位：件)"},"labels":["Q1","Q2","Q3","Q4"],"datasets":[{"label":"产品销量","data":[120,200,180,250]}],"sizes":{"width":600,"height":400}}''')
...
labels = ["Q1","Q2","Q3","Q4"]
datasets = [{"label":"产品销量","data":[120,200,180,250]}]
chartType = "bar"
...
plt.tight_layout()
plt.savefig("/Users/wisonzhu/projects/ag-ui-demo/.tmp/chart_9s57b8.png", dpi=100, bbox_inches='tight', facecolor='#0d1117')
