...
chart = json.loads('''{"chartType":"pie","title":{"literalString":"饼图"},"labels":["Q1","Q2","Q3","Q4"],"datasets":[{"label":"销量","data":[100,150,200,300]}],"sizes":{"width":600,"height":400}}''')
...
plt.tight_layout()
plt.savefig("/Users/wisonzhu/projects/ag-ui-demo/.tmp/chart_rg62ew.png", dpi=100, bbox_inches='tight', facecolor='#0d1117')
