...
datasets = [{"label":"访问量","data":[1200,1500,1800,2100,2500,2800,3200,3500,3800,4000,4200,4500]}]
chartType = "line"
...
plt.tight_layout()
plt.savefig("/Users/wisonzhu/projects/ag-ui-demo/.tmp/chart_215arx.png", dpi=100, bbox_inches='tight', facecolor='#0d1117')
