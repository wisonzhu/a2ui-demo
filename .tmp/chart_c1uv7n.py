...
chart = json.loads('''{"chartType":"bar","title":{"literalString":"柱状图"},"labels":["Q1","Q2","Q3","Q4"],"datasets":[{"label":"销量","data":[100,150,200,300]}],"sizes":{"width":600,"height":400}}''')
...
plt.tight_layout()
plt.savefig("/Users/wisonzhu/projects/ag-ui-demo/.tmp/chart_c1uv7n.png", dpi=100, bbox_inches='tight', facecolor='#0d1117')
