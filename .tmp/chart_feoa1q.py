...
ax.set_title("预算分布", color='#58a6ff', fontsize=12)
plt.tight_layout()
plt.savefig("/Users/wisonzhu/projects/ag-ui-demo/.tmp/chart_feoa1q.png", dpi=100, bbox_inches='tight', facecolor='#0d1117')
