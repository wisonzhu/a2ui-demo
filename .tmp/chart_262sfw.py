...
chart = json.loads('''{"chartType":"bar","title":{"literalString":"随机柱状图"},"labels":["一月","二月","三月","四月","五月","六月"],"datasets":[{"label":"随机数据","data":[23,45,12,67,33,89]}],"sizes":{"width":400,"height":300}}''')
...
datasets = [{"label":"随机数据","data":[23,45,12,67,33,89]}]
chartType = "bar"
...
plt.tight_layout()
plt.savefig("/Users/wisonzhu/projects/ag-ui-demo/.tmp/chart_262sfw.png", dpi=100, bbox_inches='tight', facecolor='#0d1117')
