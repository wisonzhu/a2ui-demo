...
chart = json.loads('''{"chartType":"pie","title":{"literalString":"饼图"},"labels":["A","B","C","D"],"datasets":[{"label":"示例数据","data":[30,25,20,25]}],"sizes":{"width":400,"height":300}}''')
...
labels = ["A","B","C","D"]
datasets = [{"label":"示例数据","data":[30,25,20,25]}]
chartType = "pie"
...
plt.tight_layout()
plt.savefig("/Users/wisonzhu/projects/ag-ui-demo/.tmp/chart_x4fuck.png", dpi=100, bbox_inches='tight', facecolor='#0d1117')
