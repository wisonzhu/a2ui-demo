...
chart = json.loads('''{"chartType":"bar","title":{"literalString":"销售额"},"labels":[],"datasets":[],"sizes":{"width":600,"height":400}}''')
...
plt.tight_layout()
plt.savefig("/Users/wisonzhu/projects/ag-ui-demo/.tmp/chart_5vrqro.png", dpi=100, bbox_inches='tight', facecolor='#0d1117')
