...
chart = json.loads('''{"chartType":"bar","title":{"literalString":"示例数据"},"labels":["一月","二月","三月","四月"],"datasets":[{"label":"销量","data":[12,19,3,5]}],"sizes":{"width":600,"height":400}}''')
...
labels = ["一月","二月","三月","四月"]
datasets = [{"label":"销量","data":[12,19,3,5]}]
chartType = "bar"
...
plt.tight_layout()
plt.savefig("/Users/wisonzhu/projects/ag-ui-demo/.tmp/chart_3ns47g.png", dpi=100, bbox_inches='tight', facecolor='#0d1117')
