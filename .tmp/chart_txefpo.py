...
labels = ["Q1","Q2"]
datasets = [{"label":"Series 1","data":[100,200]}]
chartType = "bar"
...
ax.set_title("Chart", color='#58a6ff', fontsize=12)
plt.tight_layout()
plt.savefig("/Users/wisonzhu/projects/ag-ui-demo/.tmp/chart_txefpo.png", dpi=100, bbox_inches='tight', facecolor='#0d1117')
