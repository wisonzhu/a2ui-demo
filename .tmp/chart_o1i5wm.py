...
datasets = [{"label":"Users","data":[1,2,1]}]
chartType = "pie"
...
ax.set_title("User Roles", color='#58a6ff', fontsize=12)
plt.tight_layout()
plt.savefig("/Users/wisonzhu/projects/ag-ui-demo/.tmp/chart_o1i5wm.png", dpi=100, bbox_inches='tight', facecolor='#0d1117')
