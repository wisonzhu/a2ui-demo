...
chart = json.loads('''{"chartType":"bar","title":{"literalString":"2024年苹果销量"},"labels":["Q1","Q2","Q3","Q4"],"datasets":[{"label":"销量（万台）","data":[100,150,200,300]}],"sizes":{"width":600,"height":400}}''')
...
labels = ["Q1","Q2","Q3","Q4"]
datasets = [{"label":"销量（万台）","data":[100,150,200,300]}]
chartType = "bar"
...
plt.tight_layout()
plt.savefig("/Users/wisonzhu/projects/ag-ui-demo/.tmp/chart_01xtbf.png", dpi=100, bbox_inches='tight', facecolor='#0d1117')
