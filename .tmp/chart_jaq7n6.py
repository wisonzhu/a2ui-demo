...
datasets = [{"label":"访问量","data":[1200,1500,1800,2200,2600,3000,3500,3800,4200,4500,4800,5000]}]
chartType = "line"
...
ax.set_title("全年月度访问量", color='#58a6ff', fontsize=12)
plt.tight_layout()
plt.savefig("/Users/wisonzhu/projects/ag-ui-demo/.tmp/chart_jaq7n6.png", dpi=100, bbox_inches='tight', facecolor='#0d1117')
