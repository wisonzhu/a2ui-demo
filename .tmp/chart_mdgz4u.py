...
datasets = [{"label":"Users","data":[1,1,1]}]
chartType = "pie"
...
ax.set_title("User Distribution", color='#58a6ff', fontsize=12)
plt.tight_layout()
plt.savefig("/Users/wisonzhu/projects/ag-ui-demo/.tmp/chart_mdgz4u.png", dpi=100, bbox_inches='tight', facecolor='#0d1117')
