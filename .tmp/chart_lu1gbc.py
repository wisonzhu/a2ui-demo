...
chart = json.loads('''{"chartType":"bar","title":{"literalString":"随机数据图表"},"labels":["一月","二月","三月","四月","五月","六月"],"datasets":[{"label":"随机数据","data":[23,45,67,12,89,34]}],"sizes":{"width":400,"height":300}}''')
...
datasets = [{"label":"随机数据","data":[23,45,67,12,89,34]}]
chartType = "bar"
...
plt.tight_layout()
plt.savefig("/Users/wisonzhu/projects/ag-ui-demo/.tmp/chart_lu1gbc.png", dpi=100, bbox_inches='tight', facecolor='#0d1117')
