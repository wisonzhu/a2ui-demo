import { ActivityDeltaEvent, ActivityMessage, ActivitySnapshotEvent, AgentCapabilities, BaseEvent, CustomEvent, Interrupt, Message, MessagesSnapshotEvent, RawEvent, ReasoningEncryptedValueEvent, ReasoningEndEvent, ReasoningMessageContentEvent, ReasoningMessageEndEvent, ReasoningMessageStartEvent, ReasoningStartEvent, ResumeEntry, RunAgentInput, RunErrorEvent, RunFinishedEvent, RunFinishedOutcome, RunStartedEvent, State, StateDeltaEvent, StateSnapshotEvent, StepFinishedEvent, StepStartedEvent, TextMessageContentEvent, TextMessageEndEvent, TextMessageStartEvent, ToolCall, ToolCallArgsEvent, ToolCallEndEvent, ToolCallResultEvent, ToolCallStartEvent } from "@ag-ui/core";
...
interface RunAgentParameters extends Partial<Pick<RunAgentInput, "runId" | "tools" | "context" | "forwardedProps">> {
...
//#endregion
//#region src/middleware/backward-compatibility-0-0-47.d.ts
/**
 ...
 */
declare class BackwardCompatibility_0_0_47 extends Middleware {
  run(input: RunAgentInput, next: AbstractAgent): Observable<BaseEvent>;
}
//#endregion
...
declare const runHttpRequest: (fetchResponse: () => Promise<Response>) => Observable<HttpEvent>;
//#endregion
...
//#endregion
//#region src/interrupts/index.d.ts
declare function getRunOutcome(event: RunFinishedEvent): RunFinishedOutcome | undefined;
declare function isInterruptExpired(interrupt: Interrupt, now?: Date): boolean;
type ResumeResponse = {
  status: "resolved";
  payload?: unknown;
} | {
...
declare function buildResumeArray(interrupts: Interrupt[], responses: Record<string, ResumeResponse>): ResumeEntry[];
//#endregion
export { AbstractAgent, type AgentConfig, type AgentDebugConfig, type AgentStateMutation, type AgentSubscriber, type AgentSubscriberParams, BackwardCompatibility_0_0_39, BackwardCompatibility_0_0_45, BackwardCompatibility_0_0_47, DebugLogger, type DebugLoggerInput, FilterToolCallsMiddleware, FunctionMiddleware, HttpAgent, type HttpAgentConfig, type HttpAgentFetchFn, Middleware, type MiddlewareFunction, type ResolvedAgentDebugConfig, type RunAgentParameters, type RunAgentResult, buildResumeArray, compactEvents, convertToLegacyEvents, createDebugLogger, defaultApplyEvents, getRunOutcome, isInterruptExpired, parseProtoStream, parseSSEStream, randomUUID, resolveAgentDebugConfig, resolveDebugLogger, runHttpRequest, structuredClone_, transformChunks, transformHttpEventStream, verifyEvents };
