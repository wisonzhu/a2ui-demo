...
export declare class A2uiBasicRowElement extends BasicCatalogA2uiLitElement<typeof RowApi> {
    /**
    ...
    protected createController(): A2uiController<{
        ...
        schema: import("zod").ZodObject<{
            ...
            justify: import("zod").ZodOptional<import("zod").ZodDefault<import("zod").ZodEnum<["center", "end", "spaceAround", "spaceBetween", "spaceEvenly", "start", "stretch"]>>>;
